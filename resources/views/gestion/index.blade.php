                        ...
                        <div class="btn-group mb-1 d-flex flex-nowrap" role="group" aria-label="Navigation">
                            ...
                            <form action="{{ route('gestion.index') }}" method="GET" class="d-inline">
                                <input type="date" name="date"
                                       value="{{ Carbon::parse($selected_date)->format('Y-m-d') }}"
                        ...
                        @if(!$open)
                            <div class="container">
                                <div class="alert alert-danger" role="alert">
                                    Le {{$selected_date}} est fermée. Si vous souhaitez modifier les horaires, veuillez vous rendre sur la page de configuration.
                                </div>

                                <!-- Bouton de redirection vers la page de configuration -->
                                <a href="{{ route('weekly_hours.index', ['year' => $year, 'week' => $week]) }}" class="btn btn-primary">Aller à la configuration des horaires</a>
                            </div>
                        @else
                        ...
                        <div class="card-body">
                            <div class="row">
                                <form action="{{ route('gestion.event_type') }}" method="post">
                                    ...
                                    <div class="mb-3">
                                        <label for="nombre_participant" class="form-label">Nombre de
                                            participants:</label>
                                ...
                                @if($event_enable || ($errors->any() && !$errors->has('nombre_participant')) )
                                    ...
                                    <form action="{{route('new_event')}}" method="post">
                                        ...
                                        @endif
                                        <button type="submit"
                                                class="btn btn-outline-primary rounded-0 mt-1 form-control">
                                            Valider
                                        </button>
                                    </form>
                                @endif
